...
INSERT INTO cnfgn (cnfgn_key_nm, cnfgn_value_ds, cnfgn_value_cl) VALUES ('log4j.override.configuration', NULL, '');
...
<Configuration status="warn" monitorInterval="60">
   <Appenders>
      ...
      <RollingFile name="RollingFile" fileName="/var/log/tomcat8/herd/herd.log" filePattern="/var/log/tomcat8/herd/herd.%d{yyyy-MM-dd}-%i.log.gz" immediateFlush="true" append="true">
         ...
         <DefaultRolloverStrategy>
            ...
            <Delete basePath="/var/log/tomcat8/herd" maxDepth="1">
   ...
   <Loggers>
      ...
      <!-- Enable method logging for all DAO "Operations" methods. -->
      <Logger name="org.finra.herd.dao.MethodLoggingAdvice" level="debug" additivity="false">
          <AppenderRef ref="RollingFile"/>
      </Logger>
