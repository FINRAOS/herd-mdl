...
execute_cmd "aws s3 cp s3://${deployBucket}/${deployBucketKey} ."
execute_cmd "unzip metastorEmr.zip"
execute_cmd "chmod 755 scripts/*"

# Run the scripts
execute_cmd "scripts/installPackagesForMetastor.sh"
execute_cmd "scripts/processHerdObjectsForMetastor.sh"
